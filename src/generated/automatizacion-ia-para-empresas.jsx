...
import * as ReactDOM from 'react-dom/client';
    ...
    const TRANSLATIONS = {
      es: {
        htmlLang: "es",
        meta: {
          title: "Automatización con IA para empresas — Guía 2026 | Orkesta",
          desc: "Guía práctica de automatización con IA para empresas y equipos. Cuándo usar n8n, cuándo agentes IA, cómo calcular el ROI y por dónde empezar.",
        },
        ...
        hero: {
          kicker: "Guía · Automatización IA para empresas · 2026",
          h1: 'Automatización con IA para empresas: <em>guía práctica 2026</em>.',
          lead: 'Las empresas y sus equipos tienen acceso hoy a herramientas de automatización e IA que antes estaban reservadas para grandes organizaciones. Esta guía explica qué automatizar, cuándo usar n8n o agentes de IA, cómo calcular el ROI y por dónde empezar.',
          ctaWA: "WhatsApp",
        ...
        intro: {
          ...
          items: [
            { iconId: "i-flujo",   t: "Automatización estructurada (n8n)",      d: "Conectar apps, disparar flujos, mover datos, manejar reintentos. Pasos predecibles donde el 'qué hacer' es siempre el mismo." },
            ...
            { iconId: "i-integra", t: "Orquestación combinada",                  d: "Para procesos de principio a fin con pasos mixtos: n8n como orquestador de flujos y Claude para los pasos que requieren razonamiento." },
            { iconId: "i-modelo",  t: "Sin dependencia tecnológica",                             d: "El stack Orkesta (n8n open-source + Claude API) vive en tu infraestructura. No dependes de plataformas cerradas con precios variables." },
          ],
        },
        decision: {
          ...
          rows: [
            ...
            { cols: ["Proceso de principio a fin con pasos mixtos", "n8n + Claude integrados", "Recibir pedido → leer correo → validar → notificar"] },
          ],
        },
        roi: {
          ...
          example: {
            ...
            lines: [
              "Proceso: 10 horas/semana a $8 USD/hora",
              "Ahorro anual potencial: $4,160 USD",
              "Implementación: $1,500 USD · Soporte: $75 USD/mes ($900 USD/año)",
              "Costo total anual: $2,400 USD",
              "Retorno neto año 1: $1,760 USD · Recuperación: ~mes 7",
            ],
        ...
        patterns: {
          ...
          title: 'Los procesos que más automatizan <em>los equipos</em>.',
          items: [
            { num: "01", t: "Procesamiento de facturas",         d: "Recibir comprobantes por correo, extraer datos con IA y cargarlos al ERP o hoja. Elimina horas de captura manual y errores de captura." },
            { num: "02", t: "Alta de clientes y CRM",            d: "Nuevo formulario o pago → crea contacto en CRM, envía bienvenida, inicia el acompañamiento. Sin intervención manual." },
            ...
            { num: "04", t: "Reportes recurrentes automáticos",  d: "Reportes de ventas, inventario u operaciones que se generan solos y se envían al equipo cada lunes a las 8:00." },
        ...
        faqs: {
          ...
          title: 'Dudas comunes sobre <em>automatización con IA en empresas</em>.',
          items: [
            ...
            { q: "¿Cuándo conviene usar n8n y cuándo agentes IA?", a: "Usa n8n cuando los pasos son predecibles: mover datos entre sistemas, disparar notificaciones, sincronizar registros. Agrega agentes IA cuando necesitas interpretar documentos, mantener conversación con clientes o tomar decisiones basadas en contexto. Para la mayoría de las empresas, la solución óptima combina ambos: n8n como orquestador y Claude para los pasos que requieren razonamiento." },
            ...
            { q: "¿Por dónde debería empezar a automatizar mi empresa?", a: "Empieza por el proceso más doloroso que también sea predecible. Señales de buen candidato: se repite más de 5 veces por semana, involucra copiar datos entre sistemas, genera errores frecuentes o tarda más de 30 minutos siempre en los mismos pasos. El diagnóstico gratuito de Orkesta (30 minutos) identifica los dos o tres procesos con mayor ROI potencial." },
            { q: "¿Una empresa puede costear la automatización con IA?", a: "Sí. Las herramientas de código abierto como n8n eliminaron las barreras de licencia que existían con plataformas corporativas. El costo real es el de implementación y soporte — no el de licencias de software. El retorno depende del proceso elegido, el tiempo que consume y el costo total de implementación y soporte." },
            { q: "¿Qué procesos suelen automatizar primero las empresas?", a: "Los cinco patrones más frecuentes son: (1) procesamiento de facturas y comprobantes entrantes, (2) alta de clientes y sincronización CRM, (3) atención y calificación de leads por WhatsApp, (4) reportes recurrentes de ventas y operaciones, (5) conciliación de pagos con Mercado Pago u otras pasarelas." },
          ],
        },
        cta: {
          title: '¿Listo para identificar el proceso <em>con más ROI en tu empresa</em>?',
          desc: "30 minutos sin compromiso. Mapeamos tus procesos, identificamos los dos o tres con mayor impacto y te decimos qué herramientas convienen y cuánto tiempo tomaría implementarlos.",
          ctaWA: "WhatsApp",
          ctaAgendar: "Agendar diagnóstico",
        },
      ...
      en: {
        htmlLang: "en",
        meta: {
          title: "AI automation for businesses — 2026 Guide | Orkesta",
          desc: "Practical guide to AI automation for businesses and teams. When to use n8n, when AI agents, how to calculate ROI and where to start.",
        },
        ...
        hero: {
          kicker: "Guide · AI automation for businesses · 2026",
          h1: "AI automation for businesses: <em>practical 2026 guide</em>.",
          lead: "Businesses and their teams now have access to automation and AI tools that were once limited to large organizations. This guide explains what to automate, when to use n8n vs AI agents, how to calculate ROI and where to start.",
          ctaWA: "WhatsApp",
        ...
        roi: {
          ...
          example: {
            ...
            lines: [
              ...
              "Net return year 1: $1,760 USD · Payback period: ~month 7",
            ],
            note: "Actual results vary by process. Orkesta's diagnostic includes an ROI estimate before you commit.",
          },
        },
        patterns: {
          kicker: "5 common patterns",
          title: "The processes teams <em>automate most</em>.",
          items: [
        ...
        faqs: {
          ...
          title: "Common questions about <em>AI automation for businesses</em>.",
          items: [
            ...
            { q: "When should I use n8n and when AI agents?", a: "Use n8n when steps are predictable: moving data between systems, triggering notifications, syncing records. Add AI agents when you need to interpret documents, maintain conversation with customers or make context-based decisions. For most businesses, the optimal solution combines both: n8n as orchestrator and Claude for steps that require reasoning." },
            ...
            { q: "Where should I start automating my business?", a: "Start with the most painful process that is also predictable. Signs of a good candidate: repeats more than 5 times per week, involves copying data between systems, generates frequent errors or takes more than 30 minutes with always the same steps. Orkesta's free diagnostic (30 minutes) identifies the two or three processes with the highest ROI potential." },
            { q: "Can a business afford AI automation?", a: "Yes. Open-source tools like n8n eliminated the licensing barriers that existed with enterprise platforms. The real cost is implementation and support — not software licenses. A project can deliver a positive return when the selected process has enough impact." },
            { q: "Which processes do businesses usually automate first?", a: "The five most frequent patterns are: (1) processing incoming invoices and receipts, (2) customer onboarding and CRM sync, (3) WhatsApp lead handling and qualification, (4) recurring sales and operations reports, (5) payment reconciliation with local gateways." },
          ],
        },
        cta: {
          title: "Ready to identify the process with <em>the highest potential return</em>?",
          desc: "30 minutes, no commitment. We map your processes, identify the two or three with the highest impact and tell you what tools and how long it would take to implement them.",
          ctaWA: "WhatsApp",
          ctaAgendar: "Book a diagnostic",
        },
